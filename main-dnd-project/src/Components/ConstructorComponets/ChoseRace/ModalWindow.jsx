      ...
      >
        ...
        <div className={style.characteristic}>
          <div className={style.characteristic__card}>
            ...
            <ul>
              {race.traits.length ? (
                race.traits.map(({ name, url }) => <li key={name}>{name}</li>)
              ) : (
                <span>{race.name} doesn't have any special traits.</span>
              )}
            </ul>
          </div>
          <div className={style.characteristic__card}>
          ...
          <div className={style.characteristic__card}>
            <p>
              {race.name} size is {race.size}
            </p>{" "}
            {race.size_description} <p> Speed : {race.speed}</p>
          </div>
        </div>
